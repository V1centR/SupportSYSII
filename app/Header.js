            ...
            <ul className="navbar-nav topbar-nav ms-md-auto align-items-center">
              ...
              <li className="nav-item topbar-icon dropdown hidden-caret">
                ...
                <ul className="dropdown-menu messages-notif-box animated fadeIn" aria-labelledby="messageDropdown">
                  ...
                  <li>
                    <div className="scroll-wrapper message-notif-scroll scrollbar-outer" style={{position: 'relative'}}>
                        <div className="message-notif-scroll scrollbar-outer scroll-content" style={{height: 'auto',marginBottom: '0px',marginRight: '0px',maxHeight: '0px'}}
>
              ...
              <li className="nav-item topbar-icon dropdown hidden-caret">
                ...
                <ul className="dropdown-menu notif-box animated fadeIn" aria-labelledby="notifDropdown">
                  ...
                  <li>
                    <div className="scroll-wrapper notif-scroll scrollbar-outer" style={{position: 'relative'}}><div className="notif-scroll scrollbar-outer scroll-content" style={{height: 'auto',marginBottom: '0px',marginRight: '0px',maxHeight: '0px'}}>
                      <div className="notif-center">
                        <a href="#">
              ...
              <li className="nav-item topbar-user dropdown hidden-caret">
                ...
                <ul className="dropdown-menu dropdown-user animated fadeIn">
                  <div className="scroll-wrapper dropdown-user-scroll scrollbar-outer" style={{position: 'relative'}}><div className="dropdown-user-scroll scrollbar-outer scroll-content" style={{height: 'auto', marginBottom: '0px',marginRight: '0px', maxHeight: '0px'}}>
                    <li>
